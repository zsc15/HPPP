function [est_im, algo_psnr] = main_exp2_GraRED_HP3(imgname, noise_level, degradation_model, index)
...
switch degradation_model
    case {'UniformBlur', 'GaussianBlur','MotionBlur','WidthGaussianBlur'}
        fprintf('Blurring...');
...
fprintf('Restoring using Gradient Halpern RED P3: GraRED-HP3\n');
...
params_admm.outer_iters = 500;%%超分用1000步
[est_im, algo_psnr] = RunGraRED_HP3(input_luma_im,...
                             ForwardFunc,...
                             BackwardFunc,...
                             InitEstFunc,...
                             0.2,...
